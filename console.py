...
product2 = Product("Organic Eggs", "Toys", "Organic with a clean, smooth finish, these eggs boast numerous functions. Now wireless, eggs are great for amping up the antics in every day life as well as for spontaneous getaways. Small enough to not fill you up, but big enough to fill the hole.", 6, 6.12, 12.60, manufacturer2, "https://2rdnmg1qbg403gumla1v9i2h-wpengine.netdna-ssl.com/wp-content/uploads/sites/3/2016/03/CC_HE_898784862_OrganicEggs-650x428.jpg")
